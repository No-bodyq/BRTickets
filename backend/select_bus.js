document.addEventListener("DOMContentLoaded", function () {
  ...
  if (bookingDetails) {
    document.getElementById("departureDetails").textContent =
      bookingDetails.departure;
    document.getElementById("arrivalDetails").textContent =
      bookingDetails.arrival;
    document.getElementById("dateDetails").textContent = new Date(
      bookingDetails.date
    ).toLocaleDateString();
    document.getElementById("seatsDetails").textContent = bookingDetails.seats;
    document.getElementById("luggageDetails").textContent =
      bookingDetails.luggage ? "With Luggage" : "No Luggage";
  }
  ...
  document
    .getElementById("confirmSeats")
    .addEventListener("click", confirmSeatSelection);
  document
...
function updateSelectedSeats() {
  ...
  proceedButton.disabled =
    selectedSeats.length !== parseInt(bookingDetails.seats);
}
