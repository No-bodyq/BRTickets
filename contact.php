...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Contact Us Brtickets</title>
                ...
                <div class="row gx-0 align-items-center" style="height: 45px;">
                    <div class="col-lg-6 text-center text-lg-start mb-lg-0">
                        <div class="d-flex flex-wrap">
                            ...
                            <a href="mailto:support@brtickets.com" class="text-muted me-0"><i class="fas fa-envelope text-primary me-2"></i>support@brtickets.com</a>
                        </div>
                    </div>
                        ...
                        <div class="row g-5">
                            <div class="col-md-6 col-lg-6 col-xl-3">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>Address</h4>
                                        <p class="mb-0">123 Main Road, Lagos, Nigeria</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>Mail Us</h4>
                                        <p class="mb-0">support@brtickets.com</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>Telephone</h4>
                                        <p class="mb-0">+234 812 345 6789</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>BRTickets.com</h4>
                                        <p class="mb-0">www.BRTickets.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="project">Your Route</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                        ...
                        <div class="p-5 bg-light rounded">
                            <div class="bg-white rounded p-4 mb-4">
                                ...
                                <div class="d-flex align-items-center flex-shrink-0 mb-3">
                                    <p class="mb-0 text-dark me-2">Address:</p><i class="fas fa-map-marker-alt text-primary me-2"></i><p class="mb-0">123 BRT Main Road, Lagos, Nigeria</p>
                                </div>
                                <div class="d-flex align-items-center">
                                    <p class="mb-0 text-dark me-2">Telephone:</p><i class="fa fa-phone-alt text-primary me-2"></i><p class="mb-0">+234 812 345 6789</p>
                                </div>
                            </div>
                            <div class="bg-white rounded p-4 mb-4">
